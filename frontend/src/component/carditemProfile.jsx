...
function CarditemProfile({houseitem, getsinglehouse}) {
    ...
    return (
        <div onClick={onClick} className='card card-side bg-white shadow-xl relative cursor-pointer my-2'>
...
export default connect(mapStatetoProps, {getsinglehouse})(CarditemProfile)